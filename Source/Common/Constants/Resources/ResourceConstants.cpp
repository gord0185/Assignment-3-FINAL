...
const char* RES_TILE_RAINBOW = "TileRainbow";
const char* RES_TILE_MOON = "TileMoon";
const char* RES_TILE_FLAG = "TileFlag";
const char* RES_TILE_WHIRLWIND = "TileWhilrwind";
const char* RES_TILE_BALLOONS = "TileBalloons";
